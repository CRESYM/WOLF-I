...
$$i_I = \frac{P_Lv_I-Q_Lv_R}{V^2} \rightarrow \Delta i_I = \frac{\partial i_I}{\partial v_I}|_{v_I =v_{I0}} \Delta v_I +  \frac{\partial i_R}{\partial v_R}|_{v_R =v_{R0}} \Delta v_R$$
...
$$\Delta V = \frac{\partial V}{\partial v_I}|_{v_I =v_{d0}} \Delta v_I +  \frac{\partial V}{\partial v_R}|_{v_R =v_{q0}} \Delta v_R = \frac{v_{d0}}{V_0}\Delta v_I + \frac{v_{q0}}{V_0}\Delta v_R$$
