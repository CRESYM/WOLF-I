...
- [Two-Area Four-Generator System (classical model)]({{ site.baseurl }}/examples/2area4gen_clsgen/) — the simplest multimachine linear model, using the classical synchronous machine model (two state variables per generator).
- [Two-Area Four-Generator System (detailed model)]({{ site.baseurl }}/examples/2area4gen_detgen/) — the multimachine linear model using the detailed 1d-2q synchronous machine model (six state variables per generator).
